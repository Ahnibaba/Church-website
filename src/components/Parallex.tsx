export const Parallax = () => {
  return (
    <div className="relative h-[70vh]"> {/* Parent container */}
      {/* Background div (now position: absolute) */}
      <div 
      ...
      {/* Overlay (now absolute instead of fixed) */}
      <div className="absolute inset-0 bg-gray-900/50"></div>
      
      {/* Content container */}
      <div className="relative z-10 flex items-center justify-center h-full px-4 text-center text-white">
        <div className="max-w-5xl mx-auto bg-[#d63037]/50 p-5">
          <h1 className="text-center font-bold text-xl sm:text-2xl tracking-wider font-roboto text-white mb-4">
