...
export default function SundaySchool() {
    ...
    const text = "Study to shew thyself approved unto God, a workman that needeth not to be ashamed, rightly dividing the word of truth. - 2Timothy 2:15"

    const data = {
        name: "Evang. Okon J. Ene",
        title: `National Sunday School Board Chairman, Redeemed International Calvary Mission`,
    ...
    return (
        <>
            <Hero imageString="/bible-study.jpg" text={text} title={title} />
