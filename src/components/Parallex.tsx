...
export const Parallax = () => {
  return (
    <div 
      ...
      style={{
        backgroundImage: "url('https://images.unsplash.com/photo-1543269865-cbf427effbad?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
    ...
    >
      ...
      <div className="relative z-10 px-4 text-center text-white max-w-5xl mx-auto bg-[#d63037]/50 p-5">
